...
// Returns the private 'App\Repository\UserPanierRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserPanierRepository.php';

return $this->privates['App\Repository\UserPanierRepository'] = new \App\Repository\UserPanierRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
