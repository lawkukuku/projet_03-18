...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ImageUserType' => function () {
    return ($this->privates['App\Form\ImageUserType'] ?? $this->privates['App\Form\ImageUserType'] = new \App\Form\ImageUserType());
