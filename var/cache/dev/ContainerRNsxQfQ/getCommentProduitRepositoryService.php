...
// Returns the private 'App\Repository\CommentProduitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommentProduitRepository.php';

return $this->privates['App\Repository\CommentProduitRepository'] = new \App\Repository\CommentProduitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
