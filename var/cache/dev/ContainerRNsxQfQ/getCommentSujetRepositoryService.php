...
// Returns the private 'App\Repository\CommentSujetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommentSujetRepository.php';

return $this->privates['App\Repository\CommentSujetRepository'] = new \App\Repository\CommentSujetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
