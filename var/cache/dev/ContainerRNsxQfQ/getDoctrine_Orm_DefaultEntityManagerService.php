...
$a->setNamespace('sf_orm_default_f3a8a210fb966996dca8daf3f220630ca4a6f5c4ce5020bbc679fd53ad48eb01');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_f3a8a210fb966996dca8daf3f220630ca4a6f5c4ce5020bbc679fd53ad48eb01');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_f3a8a210fb966996dca8daf3f220630ca4a6f5c4ce5020bbc679fd53ad48eb01');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategorieRepository' => function () {
    return ($this->privates['App\Repository\CategorieRepository'] ?? $this->load(__DIR__.'/getCategorieRepositoryService.php'));
}, 'App\\Repository\\CommentProduitRepository' => function () {
    return ($this->privates['App\Repository\CommentProduitRepository'] ?? $this->load(__DIR__.'/getCommentProduitRepositoryService.php'));
}, 'App\\Repository\\CommentSujetRepository' => function () {
    return ($this->privates['App\Repository\CommentSujetRepository'] ?? $this->load(__DIR__.'/getCommentSujetRepositoryService.php'));
}, 'App\\Repository\\PanierRepository' => function () {
    return ($this->privates['App\Repository\PanierRepository'] ?? $this->load(__DIR__.'/getPanierRepositoryService.php'));
}, 'App\\Repository\\ProduitRepository' => function () {
    return ($this->privates['App\Repository\ProduitRepository'] ?? $this->load(__DIR__.'/getProduitRepositoryService.php'));
}, 'App\\Repository\\SujetRepository' => function () {
    return ($this->privates['App\Repository\SujetRepository'] ?? $this->load(__DIR__.'/getSujetRepositoryService.php'));
}, 'App\\Repository\\UserPanierRepository' => function () {
    return ($this->privates['App\Repository\UserPanierRepository'] ?? $this->load(__DIR__.'/getUserPanierRepositoryService.php'));
}))));
